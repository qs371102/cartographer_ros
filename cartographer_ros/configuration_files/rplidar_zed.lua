...
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.occupied_space_weight = 2e2
TRAJECTORY_BUILDER_2D.ceres_scan_matcher.rotation_weight = 4e2

TRAJECTORY_BUILDER_2D.submaps.num_range_data = 120

POSE_GRAPH.optimize_every_n_nodes = 90
--POSE_GRAPH.loop_closure_translation_weight = 1.1e4
--POSE_GRAPH.loop_closure_rotation_weight = 1e5

POSE_GRAPH.constraint_builder.max_constraint_distance = 50.
--POSE_GRAPH.fast_correlative_scan_matcher.linear_search_window = 50.
